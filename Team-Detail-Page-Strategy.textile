...
This should contain any videos that have an original language that I speak that has not yet been subtitled completely. They will be display by less common languages first, then the languages we defined as very prevalent (lingua franca -- currently English and English, Britain).
