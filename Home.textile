...
# Recent changes needs some basic styling.  Just needs to be a bit prettier I think.  Maybe some colors and bolding of the username or video instead of the underline.  Twitter is probably an okay model.  If you don't have ideas for this, skip it.
...
# Make a demo page for testers where we detect browser.  Holmes will send a mockup
