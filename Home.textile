...
# Do a 1 hour round on style niceness for the timeline view (see email, and IM with Holmes when you get to this).  There will be lots of ideas here, so take a first stab at some of those top items while it's fresh in your head.  Main points:
* fix text padding on subtitles
...
* highlight active subtitle blue (same as in list)
* abutting subtitles should be divided by a single thing line
# See email "Youtube sizing issue" this one?? # -The youtube video isn't getting sized properly here (see screenshot in email of me translating one of our testing videos)- 
...
* Maybe get rid of the white border on the window in favor of something simpler
