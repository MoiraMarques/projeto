...
# subtitles that touch should be divided by a single thin line (no rounding of corners or shadow of one on top of the other)
# subtitles should display in bottom part of video (position moved up again)
# -Get rid of "shadow" on subtitles in video.-  
# make active subtitle light blue (same as in list).  might also want to change this to yellow with subtitles on the screen also highlighted yellow.
# See email "Youtube sizing issue".  Was this done already and just not deployed? # -The youtube video isn't getting sized properly here (see screenshot in email of me translating one of our testing videos)- this should be working 
