...
# -Hold spacebar functionality (the easy way): https://pybrew.codebasehq.com/mirosubs/tickets/23-  one small problem (subtitles in overlay still advance when holding spacebar) see ticket.
...
# http://bugzilla.pculture.org/show_bug.cgi?id=13078
# http://bugzilla.pculture.org/show_bug.cgi?id=13079
...
# Add numbers to the bottom tabs to indicate the progression (i.e., 1. Transcribe, 2. Sync, 3. Review). 
