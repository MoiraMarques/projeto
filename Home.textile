...
# Allow multiple widgets to run on same page: http://subtesting.com/universal-subtitles-demo/ (this should be lower priority if it's going to take more than an hour or two)
