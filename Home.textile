...
** For HTML5, this should no longer be an issue. The problem appears to be unsolvable for youtube. See http://bugzilla.pculture.org/show_bug.cgi?id=12969#c2 .
# Autopause: https://pybrew.codebasehq.com/mirosubs/tickets/110
** Waiting for response from Holmes
