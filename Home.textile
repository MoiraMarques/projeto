...
# let users Create account (in widget in dropdown menu, and in login button) http://bugzilla.pculture.org/show_bug.cgi?id=13079 / Create account page should be the same as login page on site, with a button that says create account.  Button in widget menu can say 
"Login / Create Account".  (this page: http://mirosubsdev.8planes.com/widget/login/?next=/widget/close_window/) 
