...
== Critical Stuff for next round of development ==
...
# On site: "recent activity" working or removed
...
=== Critical things on the website === 
# On website: We need a place where we can test the site before making it public.   universalsubtitles.org/front/  (but with all links working) 
