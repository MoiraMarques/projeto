...
h1. List of sites supported by vidscraper (other method preferred): 

* <a href="http://git.participatoryculture.org/vidscraper/tree/vidscraper/sites">http://git.participatoryculture.org/vidscraper/tree/vidscraper/sites</a>
