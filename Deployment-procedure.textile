...
* Holmes will manage milestone list, based on conversation with Dean and Nick.
...
* holmes drafts a script for usertesting.com based on tickets in milestone... includes any new user facing stuff, and perhaps a basic runthrough.  This can happen before milestone is complete and embargoed.
...
* Developer deploys (or developers can give janet a command to deploy)
...
After deploy: 
* Deploy at the beginning of lead developer's day for availability if there are problems.
* After a release lead developer payß particular attention to any errors generated.
